...
class RequestTransport extends Transport {
  constructor(defaultOptions) {
    super();
    if (defaultOptions?.agentOpts?.proxy) {
      console.log('proxyful')
      this.agent = new HttpsProxyAgent(defaultOptions.agentOpts.proxy, defaultOptions.agentOpts);
    } else if (defaultOptions?.agentOpts) {
